...
--
-- Host: localhost
-- Generation Time: 08-Jun-2018 às 20:30
...
CREATE TABLE `cursos` (
  ...
  `duracao` varchar(30) CHARACTER SET utf8 NOT NULL,
  `vagas` int(11) NOT NULL,
  `turno` varchar(40) CHARACTER SET utf8 NOT NULL,
